...
export function Step2Role() {
  ...
  return (
    <div className="flex flex-col items-center w-full max-w-2xl mx-auto">
      <WordReveal className="text-3xl md:text-4xl font-bold text-white mb-4 text-center" text="Tell me about yourself." />
      ...
      <form onSubmit={handleSubmit} className="w-full mb-8">
        <input 
          ...
          className="w-full p-5 bg-white border border-gray-200 rounded-2xl text-xl text-white focus:outline-none focus:border-gray-900/50 focus:ring-1 focus:ring-purple-500 transition-all text-center placeholder:text-white/30"
          autoFocus
        />
      </form>
      ...
      <div className="flex flex-wrap justify-center gap-3 mb-12">
        {examples.map(ex => (
          <button
            ...
            className="px-4 py-2 rounded-full bg-white border border-gray-200 text-white/70 hover:bg-white/10 hover:text-white transition-all text-sm"
          >
            {ex}
          </button>
        ))}
