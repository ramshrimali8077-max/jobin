...
export function Step4Location() {
  ...
  return (
    <div className="flex flex-col items-center w-full max-w-2xl mx-auto">
      <WordReveal className="text-3xl md:text-4xl font-bold text-brand-dark mb-10 text-center" text="Where are you located?" />
      <AnswerReveal>
      ...
      <form onSubmit={handleSubmit} className="w-full space-y-4 mb-10">
        <input 
          ...
          placeholder="City"
          className="w-full p-5 bg-white/80 backdrop-blur-md border border-indigo-100 rounded-2xl text-xl text-brand-dark focus:outline-none focus:border-gray-900/50 focus:ring-1 focus:ring-purple-500 transition-all placeholder:text-brand-dark/30"
          autoFocus
        />
        <input 
          type="text"
