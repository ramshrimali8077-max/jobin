      ...
      <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-12 relative">
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5 sm:gap-6 lg:gap-7 relative z-10">
            {/* STEP 1 */}
            <div className="rounded-2xl bg-white/80 backdrop-blur-md p-6 sm:p-7 flex flex-col hover:shadow-[0_8px_24px_rgba(0,0,0,0.04)] transition-shadow duration-300">
              <div className="text-[11px] font-semibold text-brand-dark/40 tracking-widest mb-4">01</div>
              ...
              <h3 className="text-[15px] sm:text-[17px] font-semibold text-brand-dark mb-1">Connect Gmail</h3>
              <p className="text-[13px] sm:text-[14px] leading-[1.6] text-brand-dark/60">
            ...
            {/* STEP 2 */}
            <div className="rounded-2xl bg-white/80 backdrop-blur-md p-6 sm:p-7 flex flex-col hover:shadow-[0_8px_24px_rgba(0,0,0,0.04)] transition-shadow duration-300">
              <div className="text-[11px] font-semibold text-brand-dark/40 tracking-widest mb-4">02</div>
              ...
              <h3 className="text-[15px] sm:text-[17px] font-semibold text-brand-dark mb-1">Upload Resume</h3>
              <p className="text-[13px] sm:text-[14px] leading-[1.6] text-brand-dark/60">
            ...
            {/* STEP 3 */}
            <div className="rounded-2xl bg-white/80 backdrop-blur-md p-6 sm:p-7 flex flex-col hover:shadow-[0_8px_24px_rgba(0,0,0,0.04)] transition-shadow duration-300">
              <div className="text-[11px] font-semibold text-brand-dark/40 tracking-widest mb-4">03</div>
              ...
              <h3 className="text-[15px] sm:text-[17px] font-semibold text-brand-dark mb-1">Import & Draft</h3>
              <p className="text-[13px] sm:text-[14px] leading-[1.6] text-brand-dark/60">
            ...
            {/* STEP 4 */}
            <div className="rounded-2xl bg-white/80 backdrop-blur-md p-6 sm:p-7 flex flex-col hover:shadow-[0_8px_24px_rgba(0,0,0,0.04)] transition-shadow duration-300">
              <div className="text-[11px] font-semibold text-brand-dark/40 tracking-widest mb-4">04</div>
              ...
              <h3 className="text-[15px] sm:text-[17px] font-semibold text-brand-dark mb-1">Approve & Send</h3>
              <p className="text-[13px] sm:text-[14px] leading-[1.6] text-brand-dark/60">
