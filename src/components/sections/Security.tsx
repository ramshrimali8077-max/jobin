    ...
    <section id="security" className="bg-[#F5F5F5] pt-16 sm:pt-20 lg:pt-28 pb-16 sm:pb-20 lg:pb-28 font-sans">
      <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-12">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          {/* HEADING */}
          <h2 className="text-gray-900 font-medium tracking-[-0.03em] leading-[1.08] text-[clamp(1.75rem,7vw,4.2rem)] sm:text-[clamp(2.5rem,5vw,4.2rem)] mb-6 sm:mb-8">
            Without your approval, <br className="hidden sm:block" /><span className="sm:hidden"> </span>
            we don't mail.
          </h2>
          
          <p className="max-w-2xl mx-auto text-[16px] sm:text-[18px] text-gray-500 leading-[1.65] mb-12 sm:mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {/* CARD 1 */}
          <div className="rounded-2xl bg-white p-7 sm:p-8 hover:shadow-[0_8px_24px_rgba(0,0,0,0.04)] transition-shadow duration-300">
            <Lock className="w-8 h-8 text-green-500 mb-4" strokeWidth={2} />
            <h3 className="text-[16px] font-semibold text-gray-900 mb-2">You Hold the Keys</h3>
          ...
          <div className="rounded-2xl bg-white p-7 sm:p-8 hover:shadow-[0_8px_24px_rgba(0,0,0,0.04)] transition-shadow duration-300">
            ...
            <h3 className="text-[16px] font-semibold text-gray-900 mb-2">Approval-Only Sending</h3>
            <p className="text-[14px] leading-[1.65] text-gray-500">
          ...
          <div className="rounded-2xl bg-white p-7 sm:p-8 hover:shadow-[0_8px_24px_rgba(0,0,0,0.04)] transition-shadow duration-300">
            ...
            <h3 className="text-[16px] font-semibold text-gray-900 mb-2">Full Transparency</h3>
            <p className="text-[14px] leading-[1.65] text-gray-500">
