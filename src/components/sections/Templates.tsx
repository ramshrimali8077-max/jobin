...
export function Templates() {
  ...
  return (
    <section id="templates" className="bg-white pt-16 sm:pt-20 lg:pt-32 pb-12 sm:pb-16 lg:pb-24 font-sans overflow-hidden">
      <div className="max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-12">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-[30%_1fr_44%] lg:items-end gap-10 lg:gap-6 xl:gap-8">
          ...
          <div className="flex flex-col gap-8 lg:self-end">
            ...
            <div>
              <button 
                ...
                className="group inline-flex bg-gray-900 text-white text-[13px] sm:text-[14px] font-medium rounded-full pl-5 sm:pl-6 pr-2 py-2 items-center gap-3 transition-colors duration-300"
              >
          ...
          <div className="flex flex-col gap-3 lg:self-start mt-8 lg:mt-0">
            {templates.map((t, i) => (
              <div key={i} className="bg-[#F5F5F5] p-5 rounded-xl flex items-center justify-between hover:bg-gray-100 transition-colors cursor-pointer">
                <div>
                  <div className="text-[15px] font-semibold text-gray-900">{t.name}</div>
                  <div className="text-[13px] text-gray-500">{t.role}</div>
                </div>
                <div className="text-[11px] text-gray-600 border border-gray-300 rounded-full px-2.5 py-0.5 font-medium">
                  {t.tag}
                </div>
              </div>
            ))}
          ...
          <div className="hidden lg:block lg:self-end bg-[#F5F5F5] rounded-2xl p-6 shadow-[0_4px_24px_rgba(0,0,0,0.02)]">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="ml-4 text-[13px] font-medium text-gray-400">New Message</span>
            </div>
            
            <div className="bg-white rounded-lg p-4 mb-6 shadow-sm border border-gray-100">
              <div className="border-b border-gray-100 pb-2 mb-2 flex items-center">
                <span className="text-gray-400 text-[12px] w-12">To:</span>
                <span className="text-gray-900 text-[13px] font-medium">hiring@stripe.com</span>
              </div>
              <div className="border-b border-gray-100 pb-2 mb-2 flex items-center">
                <span className="text-gray-400 text-[12px] w-12">From:</span>
                <span className="text-gray-900 text-[13px] font-medium">you@gmail.com</span>
              </div>
              <div className="flex items-center pt-1">
                <span className="text-gray-400 text-[12px] w-12">Subject:</span>
                <span className="text-gray-900 text-[13px] font-medium">Senior Software Engineer — Inquiry</span>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              <button className="px-5 py-2 bg-white text-gray-900 border border-gray-200 rounded-full text-[12px] font-medium hover:bg-gray-50 transition-colors">
                Edit Draft
              </button>
              <button className="px-5 py-2 bg-gray-900 text-white rounded-full text-[12px] font-medium hover:bg-gray-800 transition-colors">
                Approve & Send
              </button>
            </div>
          </div>
