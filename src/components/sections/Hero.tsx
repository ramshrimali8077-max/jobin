import { Mail, Sparkles, ArrowRight, Cpu, Bot, Zap } from 'lucide-react';
  ...
  return (
    <section ref={heroRef} className="relative h-[100dvh] min-h-[700px] flex flex-col font-sans bg-background overflow-hidden group">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_transparent_0%,_#050816_80%)]" />
      </div>
      ...
      <div className="absolute inset-0 z-10 pointer-events-none overflow-hidden">
        <motion.div 
          ...
          className="absolute top-[25%] left-[15%] w-16 h-16 glass-panel flex items-center justify-center opacity-40 shadow-[0_0_30px_rgba(59,130,246,0.3)]"
        >
        ...
        <motion.div 
          ...
          className="absolute bottom-[30%] right-[12%] w-20 h-20 glass-panel flex items-center justify-center opacity-30 shadow-[0_0_30px_rgba(139,92,246,0.3)]"
        >
          <Bot className="text-accent-purple w-10 h-10" />
        </motion.div>
        
        <motion.div 
          animate={{ y: [0, -20, 0], x: [0, 20, 0] }} 
          transition={{ duration: 9, repeat: Infinity, ease: "easeInOut", delay: 2 }}
          className="absolute top-[35%] right-[25%] w-12 h-12 glass-panel flex items-center justify-center opacity-50 shadow-[0_0_30px_rgba(236,72,153,0.3)] border-accent-pink/30"
        >
          <Zap className="text-accent-pink w-6 h-6" />
        </motion.div>
      </div>
      ...
      <div className="relative z-30 w-full max-w-5xl mx-auto px-6 pb-20 sm:pb-32 flex flex-col items-center text-center">
        ...
        <div className="animate-fade-in-slide-up mb-8 flex items-center gap-2 glass-panel px-4 py-2 rounded-full border border-white/10 shadow-[0_0_20px_rgba(59,130,246,0.15)] hover:shadow-[0_0_30px_rgba(59,130,246,0.3)] transition-all duration-500 cursor-pointer">
          ...
          <span className="text-[13px] font-medium text-gray-300">Job Mail Loop 3.0 is here</span>
          <div className="w-[1px] h-3 bg-white/20 mx-2" />
          <span className="text-[13px] font-medium text-white flex items-center gap-1 group/badge text-gradient-secondary">
            Read launch post <ArrowRight size={12} className="text-accent-pink group-hover/badge:translate-x-1 transition-transform" />
          </span>
        </div>
        ...
        <motion.h1 
          ...
          initial="hidden"
          animate="visible"
          className="text-white font-[900] tracking-[-0.04em] leading-[0.95] text-[clamp(2.5rem,8vw,6rem)] mb-6 drop-shadow-2xl flex flex-wrap justify-center gap-x-4"
        >
          <motion.span variants={wordVariants}>Your</motion.span>
          <motion.span variants={wordVariants}>job</motion.span>
          <motion.span variants={wordVariants}>search,</motion.span>
          <br className="hidden sm:block w-full" />
          <motion.span variants={wordVariants} className="text-gradient relative inline-block">
            automated.
        ...
        <p className="animate-fade-in-slide-up [animation-delay:400ms] text-[17px] sm:text-[20px] text-gray-400 max-w-2xl leading-relaxed mb-10">
        ...
        {/* CTA ROW */}
        <div className="animate-fade-in-slide-up [animation-delay:600ms] flex flex-col sm:flex-row items-center gap-6 w-full sm:w-auto">
          <button 
