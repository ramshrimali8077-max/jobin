  ...
  return (
    <section ref={heroRef} className="relative h-[100dvh] min-h-[600px] flex flex-col font-sans bg-indigo-50/40 overflow-hidden group">
      ...
      <div className="relative z-20 w-full max-w-[1440px] mx-auto px-5 sm:px-8 lg:px-12 pb-14 sm:pb-16 lg:pb-20 flex flex-col items-center text-center">
        ...
        <h1 className="text-brand-dark font-medium tracking-[-0.03em] leading-[1.08] text-[clamp(1.75rem,7vw,4.2rem)] sm:text-[clamp(2.5rem,5vw,4.2rem)]">
        ...
        <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-5">
          ...
          >
            ...
            <div className="w-7 h-7 sm:w-8 sm:h-8 bg-white/80 backdrop-blur-md/20 rounded-full flex items-center justify-center transition-transform duration-500 ease-[cubic-bezier(0.25,0.1,0.25,1)] -rotate-45 group-hover/btn:rotate-0 shrink-0">
